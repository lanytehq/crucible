...
- Schemas enforced through vendor structured-output boundaries follow
  ...
  use the portable core plus explicitly justified constructs (see the
  consuming runner's EPR-0001 Amendment 1).
- Fixture corpus is synthetic and engagement-blind by gate.
