#!/usr/bin/env python3
"""Fail-closed validator for the agentic/mission v0 contract family.
...
or through the repository's ``make check-mission-v0`` target.
"""
...
try:
    ...
    sys.stderr.write(
        ...
        "(try: uv run --with jsonschema scripts/validate-mission-v0.py)\n"
    )
    sys.exit(1)


REPO = pathlib.Path(__file__).resolve().parent.parent
FAMILY = REPO / "schemas/agentic/mission/v0"
...
SCHEMA_BASE_URI = "https://schemas.3leaps.dev/agentic/mission/v0/"

SEMANTIC_LAYER_ID = "mission/v0-semantics"
...
if failures:
    ...
    sys.exit(1)
print("mission v0 family: all checks green")
