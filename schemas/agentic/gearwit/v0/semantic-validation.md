...
6. Other phases omit `signal_id`.
7. Evidence sources may prove only these phases:

| Source           | Permitted phases                                                                         |
| ---------------- | ---------------------------------------------------------------------------------------- |
| `control_plane`  | `wait_armed`, `signal_matched`, `waiter_completed`, `coverage_rearmed`, `coverage_ended` |
